package es.medicalresponse.cc.repository;

import es.medicalresponse.cc.CcApp;
import es.medicalresponse.cc.config.Constants;
import es.medicalresponse.cc.config.audit.AuditEventConverter;
import es.medicalresponse.cc.domain.PersistentAuditEvent;
...
import static es.medicalresponse.cc.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
